...
"""
The code sends a screenshot every 1 second.
It also sends audio snippets every 0.06 seconds or so, even if it's silent.

It doesn't really see multiple frames, despite being sent them.
It only comments on the most recent ones.

This AI is really good. It got detailed league questions that I had. Wow.
It still hallucinates though.
...
I think this is more than good enough to use directly.
The remaining bits are how to handle the 10 minute limit, how to integrate into Discord, and how to use a different voice (if we want to).
"""
